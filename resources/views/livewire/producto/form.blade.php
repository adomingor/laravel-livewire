<div class="space-y-6">
    ...
    <flux:field>
        ...
        <flux:input wire:model="form.producto" id="producto" name="producto" type="text"
    ...
    <flux:field>
        ...
        <flux:textarea wire:model="form.descripcion" id="descripcion" name="descripcion"
    ...
    <flux:field>
        ...
        <flux:input wire:model="form.fecha_upd" id="fecha_upd" name="fecha_upd" type="date" readonly />
